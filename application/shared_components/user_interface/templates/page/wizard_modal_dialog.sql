...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(6328572292805538298)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328572516398538299)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328572804959538299)
,p_page_template_id=>wwv_flow_imp.id(6328572292805538298)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328573189162538299)
,p_page_template_id=>wwv_flow_imp.id(6328572292805538298)
