...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(6328563616813538295)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328563964382538296)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328564234463538296)
,p_page_template_id=>wwv_flow_imp.id(6328563616813538295)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328564595477538296)
,p_page_template_id=>wwv_flow_imp.id(6328563616813538295)
