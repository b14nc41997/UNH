...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6328711555768538312)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328711836582538312)
,p_plug_template_id=>wwv_flow_imp.id(6328711555768538312)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328712133090538312)
,p_plug_template_id=>wwv_flow_imp.id(6328711555768538312)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328712414923538312)
,p_plug_template_id=>wwv_flow_imp.id(6328711555768538312)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328712794708538312)
,p_plug_template_id=>wwv_flow_imp.id(6328711555768538312)
,p_name=>'Sub Regions'
