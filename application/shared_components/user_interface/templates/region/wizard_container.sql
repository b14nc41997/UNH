...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6328756667361538327)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328756969882538327)
,p_plug_template_id=>wwv_flow_imp.id(6328756667361538327)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328757267934538327)
,p_plug_template_id=>wwv_flow_imp.id(6328756667361538327)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328757528367538327)
,p_plug_template_id=>wwv_flow_imp.id(6328756667361538327)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328757846041538327)
,p_plug_template_id=>wwv_flow_imp.id(6328756667361538327)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328758142509538328)
,p_plug_template_id=>wwv_flow_imp.id(6328756667361538327)
