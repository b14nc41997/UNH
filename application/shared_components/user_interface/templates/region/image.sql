...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6328714762926538313)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328715091062538313)
,p_plug_template_id=>wwv_flow_imp.id(6328714762926538313)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328715327403538313)
,p_plug_template_id=>wwv_flow_imp.id(6328714762926538313)
,p_name=>'Sub Regions'
