...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6328734824771538320)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328735161008538320)
,p_plug_template_id=>wwv_flow_imp.id(6328734824771538320)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328735480569538320)
,p_plug_template_id=>wwv_flow_imp.id(6328734824771538320)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328735700903538320)
,p_plug_template_id=>wwv_flow_imp.id(6328734824771538320)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328736076709538320)
,p_plug_template_id=>wwv_flow_imp.id(6328734824771538320)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328736375436538320)
,p_plug_template_id=>wwv_flow_imp.id(6328734824771538320)
,p_name=>'Sub Regions'
