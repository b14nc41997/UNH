...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6328736932899538321)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328737225393538321)
,p_plug_template_id=>wwv_flow_imp.id(6328736932899538321)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328737526534538321)
,p_plug_template_id=>wwv_flow_imp.id(6328736932899538321)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328737809270538321)
,p_plug_template_id=>wwv_flow_imp.id(6328736932899538321)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328738116810538321)
,p_plug_template_id=>wwv_flow_imp.id(6328736932899538321)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328738409618538321)
,p_plug_template_id=>wwv_flow_imp.id(6328736932899538321)
,p_name=>'Sub Regions'
