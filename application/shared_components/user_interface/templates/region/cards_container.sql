...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6328586071212538303)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328586379325538303)
,p_plug_template_id=>wwv_flow_imp.id(6328586071212538303)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328586675021538303)
,p_plug_template_id=>wwv_flow_imp.id(6328586071212538303)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328586937648538303)
,p_plug_template_id=>wwv_flow_imp.id(6328586071212538303)
,p_name=>'Sub Regions'
