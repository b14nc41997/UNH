...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6328707374898538310)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328707636544538310)
,p_plug_template_id=>wwv_flow_imp.id(6328707374898538310)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328707935775538311)
,p_plug_template_id=>wwv_flow_imp.id(6328707374898538310)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328708229644538311)
,p_plug_template_id=>wwv_flow_imp.id(6328707374898538310)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328708501597538311)
,p_plug_template_id=>wwv_flow_imp.id(6328707374898538310)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328708899723538311)
,p_plug_template_id=>wwv_flow_imp.id(6328707374898538310)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328709151522538311)
,p_plug_template_id=>wwv_flow_imp.id(6328707374898538310)
,p_name=>'Sub Regions'
