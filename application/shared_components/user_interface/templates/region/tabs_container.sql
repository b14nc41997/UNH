...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6328749235799538325)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328749548354538325)
,p_plug_template_id=>wwv_flow_imp.id(6328749235799538325)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(6328749856181538325)
,p_plug_template_id=>wwv_flow_imp.id(6328749235799538325)
,p_name=>'Tabs'
